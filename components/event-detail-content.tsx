        ...
        <div className="flex flex-col gap-6">
            ...
            <Card>
                ...
                <CardContent className="space-y-3">
                    <p className="text-sm text-[var(--muted-foreground)]">Share this link with guests so they can RSVP without creating an account.</p>
                    {inviteUrl ? (
                    ...
                    <Form action={createInviteLinkAction.bind(null, event.id)}>
            ...
            <Card>
                ...
                <CardContent>
                    {rsvps.length === 0 ? (
                        <p className = "text-sm text-[var(--muted-foreground)]">No responses yet.</p>
                    ): (
                        <Table>
                            <TableHeader>
                                <TableRow>
